...
- Name resolution: for EVERY person the premise references but does NOT give a name (e.g. "her sister", "the cafe owner", "his best friend", "the mother"), emit a gap that PROPOSES a concrete name (first, and a surname where natural) — question "Name for <role>?", proposedAnswer the name, targetField "characters". Naming every referenced person up front stops later steps inventing conflicting names. When proposing names, AVOID AI-tell / cliche names: never use Sarah Chen, Marcus, Elara, Aria, Luna, Kira, Seraphina, or the US top-10 first/last names (James/John/Michael/David..., Smith/Johnson/Williams/Brown...); do not let more than ~30% of the female cast end in "-a"; keep names phonetically distinct (no rhyming clusters). Prefer distinctive, pronounceable, culturally-grounded names outside the current top-50 that fit the setting and the character's background.
