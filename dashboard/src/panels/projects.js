// Projects panel: templates, create/pipeline modal, list, detail view
// (steps + per-step model picker), files, compile, context & continuity tabs.
...
export function openCreateProjectModal(template, serverTemplate) {
...
export function projectAction(action, id) {
...
export function getContinuationOptions(type) {
  var map = {
    'book-planning': [
...
export function continueProjectToPhase(sourceProject, targetType) {
...
export function loadProjectFiles(id) {
...
export function loadContinuityReport(projectId) {
