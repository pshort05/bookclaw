export const ENDPOINT_CATALOG: { method: string; path: string; purpose: string }[] = [
  ...
  { method: 'GET', path: '/api/confirmations', purpose: 'List pending confirmation-gate items (approve/reject must be done by a human in the dashboard, not via this server).' },
